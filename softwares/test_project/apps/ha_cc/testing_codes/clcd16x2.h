...
/* Definitions */
#define CLCD16x2_DEBUG (0)

/* cLCD namespace */
namespace clcd16x2_ns{
...
public:
	/**
	 * @brief   clcd16x2 contructor, init lcd in 4 bit mode, increase counter.
	 */
    clcd16x2(void);
	 ...
	 *
	 * @param[in]	line, should be between 1 and 2.
	 * @param[in]	pos, should be between 1 and 16.
	 *
	...
	/**
	 * @brief   lcd's printf (only for 16x2-1 characters)
	 *
	 ...
	 * 				(CGRAM address = addr << 3).
	 */
	void set_backlight(bool backlight);//TODO: implement this function.
private:
